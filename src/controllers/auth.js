...
export const loginCallback = async (req, res) => {
  try {
    ...
    const {
      ...
      uid, sid, email: sso_email, first_name, last_name, gender, birthday, flags, facebook_id, twitter_id, kaist_id, kaist_info, kaist_info_time, sparcs_id,
    } = userData;
    const {
      // eslint-disable-next-line camelcase
      displayname, ku_person_type, ku_sex, ku_std_no, mail: kaist_email,
