...
groupSchema.virtual("followersCount").get(function() {
  return this.followers.length;
});

boardSchema.virtual("pinsCount").get(function() {
  return this.pins ? this.pins.length : undefined;
});

zaboSchema.virtual("likesCount").get(function() {
  return this.likesWithTime ? this.likesWithTime.length : undefined;
});

zaboSchema.virtual("pinsCount").get(function() {
  return this.pins ? this.pins.length : undefined;
});
